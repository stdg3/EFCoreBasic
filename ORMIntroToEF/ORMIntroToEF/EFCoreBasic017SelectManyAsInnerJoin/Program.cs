...
static void ReadData()
{
    ...
    var joinedCoursesQueryble =
        dbContext.Authors
        .SelectMany(
            // her kursu yazarla birlestiriyourz
            // yazarin id sine gore filtreliyoruz
            author => dbContext.Courses.Where(x => x.AuthorIdFK == author.AuthorId),
            // result
            (author, course) => new { Course = course, Author = author });

    //var joinedCoursesQueryble = dbContext
    //    .Courses
    //    .Join(
    //        // join courses and authors
    //        dbContext.Authors,
    //        // prop from course model
    //        x => x.AuthorIdFK,
    //        // prop from author model
    //        x => x.AuthorId,
